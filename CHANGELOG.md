...
# v3.0.4.1 (15.05.2025) - Релізна версія
...
# v3.0.4.0 (24.07.2024) - Релізна версія
...
* Відновлено старий код для php-cs-fixer.php
* Оновлено phpstan до 1.10.57
...
* Видалено дубльований масив в paypal.php
...
* Оновлено phpstan до 1.10.57
* Виправлення для phpstan.нeon
* Підказки для класів, завантажених під час bootup framework


# v3.0.3.9 (16.10.2023) - Релізна версія

### Додано:
* **Сумісність з PHP 8** - 8.0, 8.1, 8.2
...
* Виправлено лічильник маркетингових повідомлень
* Корекції до .htaccess.txt
* Виправлення автодоповнення атрибутів
* Виправлення захисту від redirect
* Виправлена помилка пагінації в розширенні Google Base

### Видалено:
* Видалено addthis

### Адміністрування:
* Створено phpstan.neon, Lint.yml, .php-cs-fixer.php для покращення якості коду
* Оновлено phpstan до версії 1.10.57
