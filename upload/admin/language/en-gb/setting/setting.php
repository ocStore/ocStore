...
$_['entry_seo_url_include_path']          = 'Category Path in Product URLs';
$_['entry_seo_url_cache']                 = 'Cache SeoPro Maps';
$_['entry_seopro_postfix']                = 'URL Postfix';
$_['entry_seopro_addslash']               = 'Trailing Slash';
$_['entry_seopro_lowercase']              = 'Lowercase URLs';
$_['entry_seopro_param_status']           = 'GET Parameter Exceptions';
$_['entry_seopro_params']                 = 'Allowed GET Parameters';
$_['help_seo_pro']                        = 'SEO keywords must be unique across the whole store';
$_['help_seo_url_include_path']           = '/category/subcategory/product';
$_['help_seo_url_cache']                  = 'Speeds up URL building, but changes to keywords require clearing the cache';
$_['help_seopro_postfix']                 = 'For example .html';
$_['help_seopro_param_status']            = 'Do not redirect URLs that carry the allowed GET parameters';
$_['help_seopro_params']                  = 'One per line';
$_['entry_seopro_language']               = 'Language In URL';
$_['text_seopro_language_param']          = 'The language parameter';
$_['text_seopro_language_prefix']         = 'Language prefix: /en/page';
$_['text_seopro_language_keyword']        = 'Separate SEO keywords per language';
$_['help_seopro_language']                = 'The default language gets no marker. In the separate keywords mode, URLs shared by two languages get a prefix';
$_['entry_add_prevnext']                  = 'Prev and Next Tags For Pagination';
$_['entry_og_status']                     = 'Open Graph Markup';
$_['entry_noindex_status']                = 'Use noindex';
$_['entry_noindex_params']                = 'Ignore noindex For GET Parameters';
$_['help_add_prevnext']                   = 'Links to the previous and next listing pages';
$_['help_og_status']                      = 'The og:title, og:type, og:url, og:image and og:site_name tags in the site header';
$_['help_noindex_status']                 = 'For service pages and for listings carrying sort, filter and pagination GET parameters';
$_['help_noindex_params']                 = 'One per line';
