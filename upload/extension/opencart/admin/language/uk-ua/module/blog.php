...
$_['text_success']     = 'Налаштування блогу збережені';
$_['text_next']        = 'Ви змінили %s блогів із %s';
$_['text_edit']        = 'Налаштування блогу';

// Form
$_['text_desc']        = 'За спаданням';
$_['text_asc']         = 'За зростанням';
$_['text_sort_name']   = 'Ім’я';
$_['text_sort_date']   = 'Дата додавання';

// Column
$_['column_total']     = 'Загальна кількість';
...
// Error
$_['error_permission'] = 'У вас немає дозволу на зміну модуля блогу';
