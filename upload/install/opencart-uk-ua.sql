...
VALUES (1, 'opencart'),
       ...
       (1, 'opencart/admin/controller/dashboard/domovyk.php'),
       ...
       (1, 'opencart/admin/language/en-gb/dashboard/domovyk.php'),
       ...
       (1, 'opencart/admin/view/template/dashboard/domovyk_form.twig'),
       (1, 'opencart/admin/view/template/dashboard/domovyk_info.twig'),
...
VALUES (0, 'config', 'config_shared', '0', 0),
       ...
       (0, 'dashboard_domovyk', 'dashboard_domovyk_width', '6', 0),
       (0, 'dashboard_domovyk', 'dashboard_domovyk_sort_order', '9', 0),
