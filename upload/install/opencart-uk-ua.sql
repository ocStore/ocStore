...
(1, 'Формат адреси', '{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city}, {zone} {postcode}\r\n{country}');
...
(15, 7, 2, 'iPhone 6', 'index.php?route=product/product&amp;path=57&amp;product_id=49', 'catalog/demo/banners/iPhone6.jpg', 0),
(16, 6, 2, 'HP Banner', 'index.php?route=product/manufacturer.info&amp;manufacturer_id=7', 'catalog/demo/compaq_presario.jpg', 0),
(17, 8, 2, 'NFL', '', 'catalog/demo/manufacturer/nfl.png', 0),
(18, 8, 2, 'RedBull', '', 'catalog/demo/manufacturer/redbull.png', 0),
(19, 8, 2, 'Sony', '', 'catalog/demo/manufacturer/sony.png', 0),
(20, 8, 2, 'Coca Cola', '', 'catalog/demo/manufacturer/cocacola.png', 0),
(21, 8, 2, 'Burger King', '', 'catalog/demo/manufacturer/burgerking.png', 0),
(22, 8, 2, 'Canon', '', 'catalog/demo/manufacturer/canon.png', 0),
(23, 8, 2, 'Harley Davidson', '', 'catalog/demo/manufacturer/harley.png', 0),
(24, 8, 2, 'Dell', '', 'catalog/demo/manufacturer/dell.png', 0),
(25, 8, 2, 'Disney', '', 'catalog/demo/manufacturer/disney.png', 0),
(26, 7, 2, 'MacBookAir', '', 'catalog/demo/banners/MacBookAir.jpg', 0),
(27, 8, 2, 'Starbucks', '', 'catalog/demo/manufacturer/starbucks.png', 0),
...
(74, 'France, Metropolitan', 'FR', 'FRA', 1, 1, 0),
...
(6, 'Знижка -10.00', '1111', 'F', '10.0000', 0, 0, '10.0000', '2014-01-01', '2020-01-01', 100000, '10000', 0, '2009-03-14 21:15:18');
...
(1, 'Гривня', 'UAH', '₴', '', '2', 1.00000000, 1, '2024-04-04 14:40:00'),
(2, 'US Dollar', 'USD', '$', '', '2', 0.02560000, 1, '2024-04-04 14:40:00'),
(3, 'Euro', 'EUR', '', '€', '2', 0.02360000, 1, '2014-04-04 14:40:00');
...
(1, 'opencart/admin/language/uk-ua'),
(1, 'opencart/admin/language/uk-ua/captcha'),
(1, 'opencart/admin/language/uk-ua/captcha/basic.php'),
(1, 'opencart/admin/language/uk-ua/currency'),
(1, 'opencart/admin/language/uk-ua/currency/ecb.php'),
(1, 'opencart/admin/language/uk-ua/currency/fixer.php'),
(1, 'opencart/admin/language/uk-ua/dashboard'),
(1, 'opencart/admin/language/uk-ua/dashboard/activity.php'),
(1, 'opencart/admin/language/uk-ua/dashboard/chart.php'),
(1, 'opencart/admin/language/uk-ua/dashboard/customer.php'),
(1, 'opencart/admin/language/uk-ua/dashboard/map.php'),
(1, 'opencart/admin/language/uk-ua/dashboard/online.php'),
(1, 'opencart/admin/language/uk-ua/dashboard/order.php'),
(1, 'opencart/admin/language/uk-ua/dashboard/recent.php'),
(1, 'opencart/admin/language/uk-ua/dashboard/sale.php'),
(1, 'opencart/admin/language/uk-ua/fraud'),
(1, 'opencart/admin/language/uk-ua/fraud/ip.php'),
(1, 'opencart/admin/language/uk-ua/module'),
(1, 'opencart/admin/language/uk-ua/module/account.php'),
(1, 'opencart/admin/language/uk-ua/module/banner.php'),
(1, 'opencart/admin/language/uk-ua/module/bestseller.php'),
(1, 'opencart/admin/language/uk-ua/module/category.php'),
(1, 'opencart/admin/language/uk-ua/module/featured.php'),
(1, 'opencart/admin/language/uk-ua/module/filter.php'),
(1, 'opencart/admin/language/uk-ua/module/html.php'),
(1, 'opencart/admin/language/uk-ua/module/information.php'),
(1, 'opencart/admin/language/uk-ua/module/latest.php'),
(1, 'opencart/admin/language/uk-ua/module/special.php'),
(1, 'opencart/admin/language/uk-ua/module/store.php'),
(1, 'opencart/admin/language/uk-ua/payment'),
(1, 'opencart/admin/language/uk-ua/payment/bank_transfer.php'),
(1, 'opencart/admin/language/uk-ua/payment/cheque.php'),
(1, 'opencart/admin/language/uk-ua/payment/cod.php'),
(1, 'opencart/admin/language/uk-ua/payment/free_checkout.php'),
(1, 'opencart/admin/language/uk-ua/report'),
(1, 'opencart/admin/language/uk-ua/report/customer.php'),
(1, 'opencart/admin/language/uk-ua/report/customer_activity.php'),
(1, 'opencart/admin/language/uk-ua/report/customer_order.php'),
(1, 'opencart/admin/language/uk-ua/report/customer_reward.php'),
(1, 'opencart/admin/language/uk-ua/report/customer_search.php'),
(1, 'opencart/admin/language/uk-ua/report/customer_subscription.php'),
(1, 'opencart/admin/language/uk-ua/report/customer_transaction.php'),
(1, 'opencart/admin/language/uk-ua/report/marketing.php'),
(1, 'opencart/admin/language/uk-ua/report/product_purchased.php'),
(1, 'opencart/admin/language/uk-ua/report/product_viewed.php'),
(1, 'opencart/admin/language/uk-ua/report/sale_coupon.php'),
(1, 'opencart/admin/language/uk-ua/report/sale_order.php'),
(1, 'opencart/admin/language/uk-ua/report/sale_return.php'),
(1, 'opencart/admin/language/uk-ua/report/sale_shipping.php'),
(1, 'opencart/admin/language/uk-ua/report/sale_tax.php'),
(1, 'opencart/admin/language/uk-ua/shipping'),
(1, 'opencart/admin/language/uk-ua/shipping/flat.php'),
(1, 'opencart/admin/language/uk-ua/shipping/free.php'),
(1, 'opencart/admin/language/uk-ua/shipping/item.php'),
(1, 'opencart/admin/language/uk-ua/shipping/pickup.php'),
(1, 'opencart/admin/language/uk-ua/shipping/weight.php'),
(1, 'opencart/admin/language/uk-ua/theme'),
(1, 'opencart/admin/language/uk-ua/theme/basic.php'),
(1, 'opencart/admin/language/uk-ua/total'),
(1, 'opencart/admin/language/uk-ua/total/coupon.php'),
(1, 'opencart/admin/language/uk-ua/total/credit.php'),
(1, 'opencart/admin/language/uk-ua/total/handling.php'),
(1, 'opencart/admin/language/uk-ua/total/low_order_fee.php'),
(1, 'opencart/admin/language/uk-ua/total/reward.php'),
(1, 'opencart/admin/language/uk-ua/total/shipping.php'),
(1, 'opencart/admin/language/uk-ua/total/sub_total.php'),
(1, 'opencart/admin/language/uk-ua/total/tax.php'),
(1, 'opencart/admin/language/uk-ua/total/total.php'),
(1, 'opencart/admin/language/uk-ua/total/voucher.php'),
...
(1, 'opencart/catalog/language/uk-ua'),
(1, 'opencart/catalog/language/uk-ua/captcha'),
(1, 'opencart/catalog/language/uk-ua/captcha/basic.php'),
(1, 'opencart/catalog/language/uk-ua/module'),
(1, 'opencart/catalog/language/uk-ua/module/account.php'),
(1, 'opencart/catalog/language/uk-ua/module/bestseller.php'),
(1, 'opencart/catalog/language/uk-ua/module/category.php'),
(1, 'opencart/catalog/language/uk-ua/module/featured.php'),
(1, 'opencart/catalog/language/uk-ua/module/filter.php'),
(1, 'opencart/catalog/language/uk-ua/module/information.php'),
(1, 'opencart/catalog/language/uk-ua/module/latest.php'),
(1, 'opencart/catalog/language/uk-ua/module/special.php'),
(1, 'opencart/catalog/language/uk-ua/module/store.php'),
(1, 'opencart/catalog/language/uk-ua/payment'),
(1, 'opencart/catalog/language/uk-ua/payment/bank_transfer.php'),
(1, 'opencart/catalog/language/uk-ua/payment/cheque.php'),
(1, 'opencart/catalog/language/uk-ua/payment/cod.php'),
(1, 'opencart/catalog/language/uk-ua/payment/free_checkout.php'),
(1, 'opencart/catalog/language/uk-ua/shipping'),
(1, 'opencart/catalog/language/uk-ua/shipping/flat.php'),
(1, 'opencart/catalog/language/uk-ua/shipping/free.php'),
(1, 'opencart/catalog/language/uk-ua/shipping/item.php'),
(1, 'opencart/catalog/language/uk-ua/shipping/pickup.php'),
(1, 'opencart/catalog/language/uk-ua/shipping/weight.php'),
(1, 'opencart/catalog/language/uk-ua/total'),
(1, 'opencart/catalog/language/uk-ua/total/coupon.php'),
(1, 'opencart/catalog/language/uk-ua/total/credit.php'),
(1, 'opencart/catalog/language/uk-ua/total/handling.php'),
(1, 'opencart/catalog/language/uk-ua/total/low_order_fee.php'),
(1, 'opencart/catalog/language/uk-ua/total/reward.php'),
(1, 'opencart/catalog/language/uk-ua/total/shipping.php'),
(1, 'opencart/catalog/language/uk-ua/total/sub_total.php'),
(1, 'opencart/catalog/language/uk-ua/total/total.php'),
(1, 'opencart/catalog/language/uk-ua/total/voucher.php'),
...
(1, 'Українська', 'uk-ua', 'uk-ua,uk', 1, 1),
...
(1, 'Банер у категоріях', 'opencart.banner', '{"name":"Банер у категоріях","banner_id":"6","effect":"fade","items":"1","controls":"0","indicators":"0","interval":"5000","width":"200","height":"180","status":"1"}'),
...
(9, 'Оподатковувані товари', 'Оподатковувані товари', '2009-01-06 23:21:53', '2011-09-23 14:07:50'),
(10, 'Завантажувані товари', 'Завантажувані товари', '2011-09-21 22:19:39', '2011-09-22 10:27:36');
...
(86, 3, 'ПДВ (20%)', '20.0000', 'P', '2011-03-09 21:17:10', '2011-09-22 22:24:29'),
(87, 3, 'Екоподаток (-2.00)', '2.0000', 'F', '2011-09-21 21:49:23', '2011-09-23 00:40:19');
...
(3480, 220, 'Черкаська область', '23', 1),
(3481, 220, 'Чернігівська область', '25', 1),
(3482, 220, 'Чернівецька область', '24', 1),
(3483, 220, 'Крим', '27', 0),
(3484, 220, 'Дніпропетровська область', '04', 1),
(3485, 220, 'Донецька область', '05', 1),
(3486, 220, 'Івано-Франківська область', '09', 1),
(3487, 220, 'Херсонська область', '21', 1),
(3488, 220, 'Хмельницька область', '22', 1),
(3489, 220, 'Кіровоградська область', '35', 1),
(3490, 220, 'Київ', '26', 1),
(3491, 220, 'Київська область', '10', 1),
(3492, 220, 'Луганська область', '12', 1),
(3493, 220, 'Львівська область', '13', 1),
(3494, 220, 'Миколаївська область', '14', 1),
(3495, 220, 'Одеська область', '15', 1),
(3496, 220, 'Полтавська область', '16', 1),
(3497, 220, 'Рівненська область', '17', 1),
(3498, 220, 'Севастополь', '28', 1),
(3499, 220, 'Сумська область', '18', 1),
(3500, 220, 'Тернопільська область', '19', 1),
(3501, 220, 'Вінницька область', '02', 1),
(3502, 220, 'Волинська область', '03', 1),
(3503, 220, 'Закарпатська область', '07', 1),
(3504, 220, 'Запорізька область', '08', 1),
(3505, 220, 'Житомирська', '06', 1),
