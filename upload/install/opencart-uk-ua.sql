...
VALUES (1, 'Формат адреси', '{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city}, {zone} {postcode}\r\n{country}');
...
VALUES (6, 'Банер для категорій', 1),
...
VALUES (79, 7, 1, 'iPhone 6', 'index.php?route=product/product&amp;path=57&amp;product_id=49', 'catalog/demo/banners/iPhone6.jpg', 0),
       ...
       (177, 7, 2, 'iPhone 6', 'index.php?route=product/product&amp;path=57&amp;product_id=49', 'catalog/demo/banners/iPhone6.jpg', 0),
       (185, 6, 2, 'HP Banner', 'index.php?route=product/manufacturer.info&amp;manufacturer_id=7', 'catalog/demo/compaq_presario.jpg', 0),
       (192, 8, 2, 'NFL', '', 'catalog/demo/manufacturer/nfl.png', 0),
       (193, 8, 2, 'RedBull', '', 'catalog/demo/manufacturer/redbull.png', 0),
       (194, 8, 2, 'Sony', '', 'catalog/demo/manufacturer/sony.png', 0),
       (189, 8, 2, 'Coca Cola', '', 'catalog/demo/manufacturer/cocacola.png', 0),
       (190, 8, 2, 'Burger King', '', 'catalog/demo/manufacturer/burgerking.png', 0),
       (191, 8, 2, 'Canon', '', 'catalog/demo/manufacturer/canon.png', 0),
       (186, 8, 2, 'Harley Davidson', '', 'catalog/demo/manufacturer/harley.png', 0),
       (187, 8, 2, 'Dell', '', 'catalog/demo/manufacturer/dell.png', 0),
       (188, 8, 2, 'Disney', '', 'catalog/demo/manufacturer/disney.png', 0),
       (178, 7, 2, 'MacBookAir', '', 'catalog/demo/banners/MacBookAir.jpg', 0),
       (195, 8, 2, 'Starbucks', '', 'catalog/demo/manufacturer/starbucks.png', 0),
       (196, 8, 2, 'Nintendo', '', 'catalog/demo/manufacturer/nintendo.png', 0);
...
VALUES (28, 1, 'Монітори', '', 'Монітори', '', ''),
       (33, 1, 'Фотоапарати', '', 'Фотоапарати', '', ''),
       (32, 1, 'Веб-камери', '', 'Веб-камери', '', ''),
       (31, 1, 'Сканери', '', 'Сканери', '', ''),
       (30, 1, 'Принтери', '', 'Принтери', '', ''),
       (29, 1, 'Мишки і трекболи', '', 'Мишки і трекболи', '', ''),
       (27, 1, 'Mac', '', 'Mac', '', ''),
       (26, 1, 'PC', '', 'PC', '', ''),
       (17, 1, 'Програми', '', 'Програми', '', ''),
       (25, 1, 'Комплектуючі', '', 'Комплектуючі', '', ''),
       (24, 1, 'Телефони та PDA', '', 'Телефони та PDA', '', ''),
       (20, 1, 'Комп’ютери', '&lt;p&gt;\r\n	Приклад тексту опису категорії&lt;/p&gt;\r\n', 'Комп’ютери', 'Приклад тексту опису категорії', ''),
       (35, 1, 'test 1', '', 'test 1', '', ''),
       (36, 1, 'test 2', '', 'test 2', '', ''),
       (37, 1, 'test 5', '', 'test 5', '', ''),
       (38, 1, 'test 4', '', 'test 4', '', ''),
...
VALUES (1, 1, 'Afghanistan'),
       ...
       (174, 1, 'Reunion'),
       (175, 1, 'Romania'),
       (176, 1, 'russia is a terrorist state'),
       (177, 1, 'Rwanda'),
...
VALUES ('Знижка -10%', '2222', 'P', '10.0000', 0, 0, '0.0000', '2014-01-01', '2020-01-01', 10, '10', 0, '2009-01-27 13:55:03'),
       ('Безкоштовна доставка', '3333', 'P', '0.0000', 0, 1, '100.0000', '2014-01-01', '2014-02-01', 10, '10', 0, '2009-03-14 21:13:53'),
       ('Знижка -10.00', '1111', 'F', '10.0000', 0, 0, '10.0000', '2014-01-01', '2020-01-01', 100000, '10000', 0, '2009-03-14 21:15:18');
...
VALUES ('Гривня', 'UAH', '₴', '', '2', 1.00000000, 1, '2024-04-04 14:40:00'),
       ('US Dollar', 'USD', '$', '', '2', 0.02560000, 1, '2024-04-04 14:40:00'),
       ('Euro', 'EUR', '', '€', '2', 0.02360000, 1, '2024-04-04 14:40:00');
...
VALUES (1, 1, 'Стандартна', 'Стандартна група покупців'),
       (2, 1, 'Роздріб', 'Роздрібні покупці'),
       (3, 1, 'Опт', 'Оптові покупці'),
...
VALUES ('opencart', 'currency', 'ecb'),
       ('opencart', 'currency', 'nbu'),
       ('opencart', 'module', 'featured'),
       ('opencart', 'module', 'featured_product'),
       ('opencart', 'module', 'blog'),
       ('opencart', 'module', 'article_featured'),
...
VALUES (1, 'opencart'),
       ...
       (1, 'opencart/admin/controller/currency/nbu.php'),
       ...
       (1, 'opencart/admin/controller/dashboard/domovyi.php'),
       ...
       (1, 'opencart/admin/controller/module/featured_product.php'),
       (1, 'opencart/admin/controller/module/blog.php'),
       (1, 'opencart/admin/controller/module/article_featured.php'),
       (1, 'opencart/admin/controller/module/topic.php'),
       ...
       (1, 'opencart/admin/language/en-gb/currency/nbu.php'),
       ...
       (1, 'opencart/admin/language/en-gb/dashboard/domovyi.php'),
       ...
       (1, 'opencart/admin/language/en-gb/module/featured_product.php'),
       ...
       (1, 'opencart/admin/view/template/currency/nbu.twig'),
       ...
       (1, 'opencart/admin/view/image/domovyi.png'),
       (1, 'opencart/admin/view/template/dashboard/domovyi_fields.twig'),
       (1, 'opencart/admin/view/template/dashboard/domovyi_form.twig'),
       (1, 'opencart/admin/view/template/dashboard/domovyi_info.twig'),
       (1, 'opencart/admin/view/template/dashboard/domovyi_panel.twig'),
       (1, 'opencart/admin/view/template/dashboard/phpinfo.twig'),
       ...
       (1, 'opencart/admin/view/template/module/featured_product.twig'),
       (1, 'opencart/admin/view/template/module/blog.twig'),
       (1, 'opencart/admin/view/template/module/article_featured.twig'),
       (1, 'opencart/admin/view/template/module/topic.twig'),
       ...
       (1, 'opencart/catalog/controller/currency/nbu.php'),
       ...
       (1, 'opencart/catalog/controller/module/featured_product.php'),
       (1, 'opencart/catalog/controller/module/blog.php'),
       (1, 'opencart/catalog/controller/module/article_featured.php'),
       (1, 'opencart/catalog/controller/module/topic.php'),
       ...
       (1, 'opencart/catalog/language/en-gb/module/featured_product.php'),
       ...
       (1, 'opencart/catalog/view/template/module/featured_product.twig'),
       (1, 'opencart/catalog/view/template/module/blog.twig'),
       (1, 'opencart/catalog/view/template/module/article_featured.twig'),
       (1, 'opencart/catalog/view/template/module/topic.twig'),
...
VALUES ('Складська одиниця обліку', 'SKU', 1),
       ('Універсальний код товару', 'UPC', 1),
       ('Європейський артикул', 'EAN', 1),
       ('Японський артикул', 'JAN', 1),
       ('Міжнародний стандартний номер книги', 'ISBN', 1),
       ('Номер деталі виробника', 'MPN', 1);
...
VALUES (1, 'Українська', 'uk-ua', 'uk-ua,uk', 1, 1),
       (2, 'English', 'en-gb', 'en-gb,en', 2, 1);
...
VALUES (1, 'Головна'),
       ...
       (8, 'Контакти'),
       (9, 'Карта сайту'),
       (10, 'Обліковий запис партнера'),
       (11, 'Інформаційна сторінка'),
       (12, 'Порівняння'),
       (13, 'Результати пошуку'),
       (14, 'Блог'),
       (15, 'Сторінка виробника');
...
VALUES (1, 10, 'opencart.account', 'column_right', 1),
       ...
       (9, 14, 'opencart.article_featured.5', 'column_left', 2),
       (10, 3, 'opencart.featured_product.6', 'column_left', 3),
       (11, 15, 'opencart.featured_product.6', 'column_left', 1),
       (12, 1, 'opencart.blog.7', 'content_bottom', 2);
...
VALUES (1, 6, 0, 'account/%'),
       ...
       (17, 15, 0, 'product/manufacturer.info');
...
VALUES (1, 'Банер у категоріях', 'opencart.banner', '{"name":"Банер у категоріях","banner_id":"6","effect":"fade","items":"1","controls":"0","indicators":"0","interval":"5000","width":"200","height":"180","status":"1"}'),
       (2, 'Рекомендовані товари', 'opencart.featured', '{"name":"Рекомендуємо","product_name":"","product":["43","40","42","30"],"axis":"horizontal","limit":"4","width":"200","height":"200","status":"1"}'),
       (3, 'Слайдшоу на головній', 'opencart.banner', '{"name":"Слайдшоу на головній","banner_id":"7","effect":"slide","items":"1","controls":"1","indicators":"1","interval":"5000","width":"1140","height":"380","status":"1"}'),
       (4, 'Карусель виробників на головній', 'opencart.banner', '{"name":"Виробники на головній","banner_id":"8","effect":"slide","items":"5","controls":"1","indicators":"1","interval":"5000","width":"130","height":"100","status":"1"}'),
       (5, 'Рекомендовані статті', 'opencart.article_featured', '{"name":"Рекомендовані статті","article_name":"","article":["123","120","124","125"],"axis":"horizontal","limit":"4","description_length":"100","width":"200","height":"200","status":"1"}'),
       (6, 'Рекомендовані товари в категоріях та виробниках', 'opencart.featured_product', '{"name":"Рекомендовані товари в категоріях та виробниках","limit":"4","width":"200","height":"200","status":"1"}'),
       (7, 'Останні статті', 'opencart.blog', '{"name":"Останні статті","sort":"a.date_added","order":"DESC","limit":"4","description_length":"100","width":"200","height":"200","status":"1"}');
...
VALUES (224, 35, 11, '', 1),
       (225, 47, 12, '2024-04-04', 1),
       (223, 42, 2, '', 1),
       (217, 42, 5, '', 1),
       (209, 42, 6, '', 1),
       (218, 42, 1, '', 1),
       (208, 42, 4, 'test', 1),
       (219, 42, 8, '2024-04-04', 1),
       (222, 42, 7, '', 1),
       (221, 42, 9, '22:25', 1),
       (220, 42, 10, '2024-04-04 10:00', 1),
       (226, 30, 5, '', 1);
...
VALUES (1, 1, 'Очікується повернення'),
       (2, 1, 'Повернення коштів'),
       (3, 1, 'Відправлено заміну'),
       (4, 1, 'Відшкодовано'),
...
VALUES (1, 1, 'Отримано/доставлено несправним (зламаним)'),
...
VALUES (0, 'config', 'config_shared', '0', 0),
       ...
       (0, 'config', 'config_language_catalog', 'uk-ua', 0),
       ...
       (0, 'config', 'config_order_status_id', '2', 0),
       ...
       (0, 'config', 'config_owner', 'Власник', 0),
       (0, 'config', 'config_address', 'Адреса', 0),
       (0, 'config', 'config_name', 'Магазин', 0),
       ...
       (0, 'dashboard_domovyi', 'dashboard_domovyi_status', '1', 0),
       (0, 'dashboard_domovyi', 'dashboard_domovyi_width', '12', 0),
       (0, 'dashboard_domovyi', 'dashboard_domovyi_sort_order', '10', 0),
       (0, 'dashboard_domovyi', 'dashboard_domovyi_cron', '{"logs":{"status":"1","size":"100","time":"30"},"cache":{"status":"0","size":"100","time":"30"},"imagescache":{"status":"0","size":"100","time":"30"}}', 1),
       (0, 'dashboard_domovyi', 'dashboard_domovyi_free_space_status', '0', 0),
       (0, 'dashboard_domovyi', 'dashboard_domovyi_disk_free_space', '500', 0),
       (0, 'dashboard_domovyi', 'dashboard_domovyi_danger_funtions', 'exec\r\npassthru\r\nini_get\r\nini_get_all\r\nparse_ini_file\r\nphp_uname\r\nsystem\r\nshell_exec\r\nshow_source\r\npcntl_exec\r\nexpect_popen\r\nproc_open\r\npopen', 0),
       (0, 'dashboard_domovyi', 'dashboard_domovyi_warning_funtions', 'diskfreespace\r\ndisk_total_space\r\nfileperms\r\nfopen\r\nphpversion\r\nopendir\r\nposix_getpwuid\r\nposix_uname', 0),
       ...
       (0, 'config', 'config_comment_interval', '60', 0),
       (0, 'module_topic', 'module_topic_article_count', '1', 0),
       (0, 'config', 'config_seo_pro', '1', 0),
       (0, 'config', 'config_seo_url_include_path', '1', 0),
       (0, 'config', 'config_seo_url_cache', '1', 0),
       (0, 'config', 'config_seopro_postfix', '', 0),
...
VALUES (0, 1, 'product_id', '47', 'hp-lp3065', 1),
       ...
       (0, 2, 'route', 'product/manufacturer.info', 'brand', -2),
       (0, 2, 'route', 'cms/blog', 'blog', -1),
       (0, 2, 'route', 'cms/blog.info', 'article', -1);
...
VALUES (9, 'Оподатковувані товари', 'Оподатковувані товари'),
       (10, 'Завантажувані товари', 'Завантажувані товари');
...
VALUES (86, 3, 'ПДВ (20%)', '20.0000', 'P'),
       (87, 3, 'Екоподаток (-2.00)', '2.0000', 'F');
...
VALUES (1, 'Адміністратори', '{\"access\":[\"catalog\\/attribute\",\"catalog\\/attribute_group\",\"catalog\\/category\",\"catalog\\/download\",\"catalog\\/filter\",\"catalog\\/filter_group\",\"catalog\\/identifier\",\"catalog\\/information\",\"catalog\\/manufacturer\",\"catalog\\/option\",\"catalog\\/product\",\"catalog\\/review\",\"catalog\\/subscription_plan\",\"cms\\/antispam\",\"cms\\/article\",\"cms\\/comment\",\"cms\\/topic\",\"common\\/developer\",\"common\\/filemanager\",\"common\\/search\",\"common\\/security\",\"customer\\/address\",\"customer\\/custom_field\",\"customer\\/customer\",\"customer\\/customer_approval\",\"customer\\/customer_group\",\"customer\\/gdpr\",\"design\\/banner\",\"design\\/layout\",\"design\\/seo_url\",\"design\\/theme\",\"design\\/translation\",\"error\\/exception\",\"event\\/modification\",\"extension\\/analytics\",\"extension\\/captcha\",\"extension\\/currency\",\"extension\\/dashboard\",\"extension\\/feed\",\"extension\\/fraud\",\"extension\\/language\",\"extension\\/marketplace\",\"extension\\/module\",\"extension\\/opencart\\/api\\/coupon\",\"extension\\/opencart\\/api\\/reward\",\"extension\\/opencart\\/captcha\\/basic\",\"extension\\/opencart\\/currency\\/ecb\",\"extension\\/opencart\\/currency\\/fixer\",\"extension\\/opencart\\/currency\\/nbu\",\"extension\\/opencart\\/dashboard\\/activity\",\"extension\\/opencart\\/dashboard\\/chart\",\"extension\\/opencart\\/dashboard\\/customer\",\"extension\\/opencart\\/dashboard\\/domovyi\",\"extension\\/opencart\\/dashboard\\/map\",\"extension\\/opencart\\/dashboard\\/online\",\"extension\\/opencart\\/dashboard\\/order\",\"extension\\/opencart\\/dashboard\\/recent\",\"extension\\/opencart\\/dashboard\\/sale\",\"extension\\/opencart\\/fraud\\/ddos\",\"extension\\/opencart\\/fraud\\/ip\",\"extension\\/opencart\\/module\\/account\",\"extension\\/opencart\\/module\\/article_featured\",\"extension\\/opencart\\/module\\/banner\",\"extension\\/opencart\\/module\\/bestseller\",\"extension\\/opencart\\/module\\/blog\",\"extension\\/opencart\\/module\\/category\",\"extension\\/opencart\\/module\\/featured\",\"extension\\/opencart\\/module\\/featured_product\",\"extension\\/opencart\\/module\\/filter\",\"extension\\/opencart\\/module\\/html\",\"extension\\/opencart\\/module\\/information\",\"extension\\/opencart\\/module\\/latest\",\"extension\\/opencart\\/module\\/special\",\"extension\\/opencart\\/module\\/store\",\"extension\\/opencart\\/module\\/topic\",\"extension\\/opencart\\/payment\\/bank_transfer\",\"extension\\/opencart\\/payment\\/cheque\",\"extension\\/opencart\\/payment\\/cod\",\"extension\\/opencart\\/payment\\/free_checkout\",\"extension\\/opencart\\/report\\/customer\",\"extension\\/opencart\\/report\\/customer_activity\",\"extension\\/opencart\\/report\\/customer_order\",\"extension\\/opencart\\/report\\/customer_reward\",\"extension\\/opencart\\/report\\/customer_search\",\"extension\\/opencart\\/report\\/customer_transaction\",\"extension\\/opencart\\/report\\/marketing\",\"extension\\/opencart\\/report\\/product_purchased\",\"extension\\/opencart\\/report\\/product_viewed\",\"extension\\/opencart\\/report\\/sale_coupon\",\"extension\\/opencart\\/report\\/sale_order\",\"extension\\/opencart\\/report\\/sale_return\",\"extension\\/opencart\\/report\\/sale_shipping\",\"extension\\/opencart\\/report\\/sale_tax\",\"extension\\/opencart\\/report\\/subscription\",\"extension\\/opencart\\/shipping\\/flat\",\"extension\\/opencart\\/shipping\\/free\",\"extension\\/opencart\\/shipping\\/item\",\"extension\\/opencart\\/shipping\\/pickup\",\"extension\\/opencart\\/shipping\\/weight\",\"extension\\/opencart\\/theme\\/basic\",\"extension\\/opencart\\/total\\/coupon\",\"extension\\/opencart\\/total\\/credit\",\"extension\\/opencart\\/total\\/handling\",\"extension\\/opencart\\/total\\/low_order_fee\",\"extension\\/opencart\\/total\\/reward\",\"extension\\/opencart\\/total\\/shipping\",\"extension\\/opencart\\/total\\/sub_total\",\"extension\\/opencart\\/total\\/tax\",\"extension\\/opencart\\/total\\/total\",\"extension\\/other\",\"extension\\/payment\",\"extension\\/report\",\"extension\\/shipping\",\"extension\\/theme\",\"extension\\/total\",\"language\\/ukrainian\",\"localisation\\/address_format\",\"localisation\\/country\",\"localisation\\/currency\",\"localisation\\/geo_zone\",\"localisation\\/language\",\"localisation\\/length_class\",\"localisation\\/location\",\"localisation\\/order_status\",\"localisation\\/return_action\",\"localisation\\/return_reason\",\"localisation\\/return_status\",\"localisation\\/stock_status\",\"localisation\\/subscription_status\",\"localisation\\/tax_class\",\"localisation\\/tax_rate\",\"localisation\\/weight_class\",\"localisation\\/zone\",\"mail\\/affiliate\",\"mail\\/authorize\",\"mail\\/customer\",\"mail\\/forgotten\",\"mail\\/gdpr\",\"mail\\/returns\",\"mail\\/reward\",\"mail\\/subscription\",\"mail\\/transaction\",\"marketing\\/affiliate\",\"marketing\\/contact\",\"marketing\\/coupon\",\"marketing\\/marketing\",\"marketplace\\/api\",\"marketplace\\/cron\",\"marketplace\\/event\",\"marketplace\\/extension\",\"marketplace\\/installer\",\"marketplace\\/marketplace\",\"marketplace\\/modification\",\"marketplace\\/opencartforum\",\"marketplace\\/promotion\",\"marketplace\\/startup\",\"report\\/online\",\"report\\/report\",\"report\\/statistics\",\"sale\\/order\",\"sale\\/returns\",\"sale\\/subscription\",\"setting\\/setting\",\"setting\\/store\",\"tool\\/backup\",\"tool\\/log\",\"tool\\/notification\",\"tool\\/upgrade\",\"tool\\/upload\",\"user\\/api\",\"user\\/profile\",\"user\\/user\",\"user\\/user_permission\"],\"modify\":[\"catalog\\/attribute\",\"catalog\\/attribute_group\",\"catalog\\/category\",\"catalog\\/download\",\"catalog\\/filter\",\"catalog\\/filter_group\",\"catalog\\/identifier\",\"catalog\\/information\",\"catalog\\/manufacturer\",\"catalog\\/option\",\"catalog\\/product\",\"catalog\\/review\",\"catalog\\/subscription_plan\",\"cms\\/antispam\",\"cms\\/article\",\"cms\\/comment\",\"cms\\/topic\",\"common\\/developer\",\"common\\/filemanager\",\"common\\/search\",\"common\\/security\",\"customer\\/address\",\"customer\\/custom_field\",\"customer\\/customer\",\"customer\\/customer_approval\",\"customer\\/customer_group\",\"customer\\/gdpr\",\"design\\/banner\",\"design\\/layout\",\"design\\/seo_url\",\"design\\/theme\",\"design\\/translation\",\"error\\/exception\",\"event\\/modification\",\"extension\\/analytics\",\"extension\\/captcha\",\"extension\\/currency\",\"extension\\/dashboard\",\"extension\\/feed\",\"extension\\/fraud\",\"extension\\/language\",\"extension\\/marketplace\",\"extension\\/module\",\"extension\\/opencart\\/api\\/coupon\",\"extension\\/opencart\\/api\\/reward\",\"extension\\/opencart\\/captcha\\/basic\",\"extension\\/opencart\\/currency\\/ecb\",\"extension\\/opencart\\/currency\\/fixer\",\"extension\\/opencart\\/currency\\/nbu\",\"extension\\/opencart\\/dashboard\\/activity\",\"extension\\/opencart\\/dashboard\\/chart\",\"extension\\/opencart\\/dashboard\\/customer\",\"extension\\/opencart\\/dashboard\\/domovyi\",\"extension\\/opencart\\/dashboard\\/map\",\"extension\\/opencart\\/dashboard\\/online\",\"extension\\/opencart\\/dashboard\\/order\",\"extension\\/opencart\\/dashboard\\/recent\",\"extension\\/opencart\\/dashboard\\/sale\",\"extension\\/opencart\\/fraud\\/ddos\",\"extension\\/opencart\\/fraud\\/ip\",\"extension\\/opencart\\/module\\/account\",\"extension\\/opencart\\/module\\/article_featured\",\"extension\\/opencart\\/module\\/banner\",\"extension\\/opencart\\/module\\/bestseller\",\"extension\\/opencart\\/module\\/blog\",\"extension\\/opencart\\/module\\/category\",\"extension\\/opencart\\/module\\/featured\",\"extension\\/opencart\\/module\\/featured_product\",\"extension\\/opencart\\/module\\/filter\",\"extension\\/opencart\\/module\\/html\",\"extension\\/opencart\\/module\\/information\",\"extension\\/opencart\\/module\\/latest\",\"extension\\/opencart\\/module\\/special\",\"extension\\/opencart\\/module\\/store\",\"extension\\/opencart\\/module\\/topic\",\"extension\\/opencart\\/payment\\/bank_transfer\",\"extension\\/opencart\\/payment\\/cheque\",\"extension\\/opencart\\/payment\\/cod\",\"extension\\/opencart\\/payment\\/free_checkout\",\"extension\\/opencart\\/report\\/customer\",\"extension\\/opencart\\/report\\/customer_activity\",\"extension\\/opencart\\/report\\/customer_order\",\"extension\\/opencart\\/report\\/customer_reward\",\"extension\\/opencart\\/report\\/customer_search\",\"extension\\/opencart\\/report\\/customer_transaction\",\"extension\\/opencart\\/report\\/marketing\",\"extension\\/opencart\\/report\\/product_purchased\",\"extension\\/opencart\\/report\\/product_viewed\",\"extension\\/opencart\\/report\\/sale_coupon\",\"extension\\/opencart\\/report\\/sale_order\",\"extension\\/opencart\\/report\\/sale_return\",\"extension\\/opencart\\/report\\/sale_shipping\",\"extension\\/opencart\\/report\\/sale_tax\",\"extension\\/opencart\\/report\\/subscription\",\"extension\\/opencart\\/shipping\\/flat\",\"extension\\/opencart\\/shipping\\/free\",\"extension\\/opencart\\/shipping\\/item\",\"extension\\/opencart\\/shipping\\/pickup\",\"extension\\/opencart\\/shipping\\/weight\",\"extension\\/opencart\\/theme\\/basic\",\"extension\\/opencart\\/total\\/coupon\",\"extension\\/opencart\\/total\\/credit\",\"extension\\/opencart\\/total\\/handling\",\"extension\\/opencart\\/total\\/low_order_fee\",\"extension\\/opencart\\/total\\/reward\",\"extension\\/opencart\\/total\\/shipping\",\"extension\\/opencart\\/total\\/sub_total\",\"extension\\/opencart\\/total\\/tax\",\"extension\\/opencart\\/total\\/total\",\"extension\\/other\",\"extension\\/payment\",\"extension\\/report\",\"extension\\/shipping\",\"extension\\/theme\",\"extension\\/total\",\"language\\/ukrainian\",\"localisation\\/address_format\",\"localisation\\/country\",\"localisation\\/currency\",\"localisation\\/geo_zone\",\"localisation\\/language\",\"localisation\\/length_class\",\"localisation\\/location\",\"localisation\\/order_status\",\"localisation\\/return_action\",\"localisation\\/return_reason\",\"localisation\\/return_status\",\"localisation\\/stock_status\",\"localisation\\/subscription_status\",\"localisation\\/tax_class\",\"localisation\\/tax_rate\",\"localisation\\/weight_class\",\"localisation\\/zone\",\"mail\\/affiliate\",\"mail\\/authorize\",\"mail\\/customer\",\"mail\\/forgotten\",\"mail\\/gdpr\",\"mail\\/returns\",\"mail\\/reward\",\"mail\\/subscription\",\"mail\\/transaction\",\"marketing\\/affiliate\",\"marketing\\/contact\",\"marketing\\/coupon\",\"marketing\\/marketing\",\"marketplace\\/api\",\"marketplace\\/cron\",\"marketplace\\/event\",\"marketplace\\/extension\",\"marketplace\\/installer\",\"marketplace\\/marketplace\",\"marketplace\\/modification\",\"marketplace\\/opencartforum\",\"marketplace\\/promotion\",\"marketplace\\/startup\",\"report\\/online\",\"report\\/report\",\"report\\/statistics\",\"sale\\/order\",\"sale\\/returns\",\"sale\\/subscription\",\"setting\\/setting\",\"setting\\/store\",\"tool\\/backup\",\"tool\\/log\",\"tool\\/notification\",\"tool\\/upgrade\",\"tool\\/upload\",\"user\\/api\",\"user\\/profile\",\"user\\/user\",\"user\\/user_permission\"]}'),
       (2, 'Демонстрація', ''),
       (3, 'Маркетинг', ''),
       (4, 'Введення даних про товари', ''),
       (5, 'Обробка замовлень', ''),
       (6, 'Бухгалтерія', ''),
       (7, 'Обслуговування покупців', ''),
       (8, 'Аналітика', ''),
       (9, 'Написання контенту', '');
...
INSERT INTO `oc_topic` (`topic_id`, `sort_order`, `status`, `parent_id`, `noindex`)
VALUES (69, 0, 1, 0, 0),
       (70, 0, 1, 0, 0),
       (71, 0, 1, 69, 0);
...
INSERT INTO `oc_topic_to_store` (`topic_id`, `store_id`)
VALUES (69, 0),
       (70, 0),
       (71, 0);
...
--
-- Dumping data for table `oc_topic_path`
--

INSERT INTO `oc_topic_path` (`topic_id`, `path_id`, `level`)
VALUES (69, 69, 0),
       (71, 71, 1),
       (71, 69, 0),
       (70, 70, 0);
...
INSERT INTO `oc_article` (`article_id`, `topic_id`, `author`, `rating`, `status`, `date_added`, `date_modified`, `sort_order`, `date_available`, `viewed`, `noindex`)
VALUES (120, 71, 'ocStore', 0, 1, '2026-08-04 10:15:00', '2026-08-04 10:15:00', 1, '2026-08-04', 8, 0),
       (123, 70, 'ocStore', 0, 1, '2026-08-11 12:40:00', '2026-08-12 09:05:00', 1, '2026-08-11', 136, 0),
       (124, 71, 'ocStore', 0, 1, '2026-08-19 08:30:00', '2026-08-19 08:30:00', 1, '2026-08-19', 2, 0),
       (125, 69, 'ocStore', 0, 1, '2026-08-25 17:20:00', '2026-08-25 17:20:00', 1, '2026-08-25', 2, 0);
...
INSERT INTO `oc_article_to_store` (`article_id`, `store_id`)
VALUES (120, 0),
       (123, 0),
       (124, 0),
       (125, 0);
...
--
-- Dumping data for table `oc_article_to_topic`
--

INSERT INTO `oc_article_to_topic` (`article_id`, `topic_id`, `main_topic`)
VALUES (123, 70, 1),
       (125, 69, 1),
       (120, 69, 0),
       (120, 71, 1),
...
INSERT INTO `oc_article_related` (`article_id`, `related_id`)
VALUES (120, 123),
       (120, 124),
       (123, 120),
       (123, 124),
...
--
-- Dumping data for table `oc_article_to_product`
--

INSERT INTO `oc_article_to_product` (`article_id`, `product_id`)
VALUES (120, 28),
       (120, 30),
       (120, 40),
       (120, 41),
...
--
-- Dumping data for table `oc_article_to_manufacturer`
--

INSERT INTO `oc_article_to_manufacturer` (`article_id`, `manufacturer_id`)
VALUES (120, 8),
       (120, 9),
       (123, 8),
       (124, 7);
...
--
-- Dumping data for table `oc_article_to_category`
--

INSERT INTO `oc_article_to_category` (`article_id`, `category_id`)
VALUES (120, 26),
       (123, 20),
       (124, 18),
       (125, 18),
...
INSERT INTO `oc_seo_url` (`store_id`, `language_id`, `key`, `value`, `keyword`, `sort_order`)
VALUES (0, 1, 'topic_id', '69', 'novyny', 0),
       (0, 2, 'topic_id', '69', 'news', 0),
       (0, 1, 'topic_id', '70', 'oglyady', 0),
       (0, 2, 'topic_id', '70', 'reviews', 0),
       (0, 1, 'topic_id', '71', 'anonsy', 0),
       (0, 2, 'topic_id', '71', 'announcements', 0),
       (0, 1, 'article_id', '120', 'ocstore-cms', 0),
       (0, 2, 'article_id', '120', 'ocstore-cart', 0),
       (0, 1, 'article_id', '123', 'oglyad-pershyi', 0),
       (0, 2, 'article_id', '123', 'first-review', 0),
       (0, 1, 'article_id', '124', 'vazhlyva-stattya', 0),
       (0, 2, 'article_id', '124', 'important-article', 0),
       (0, 1, 'article_id', '125', 'persha-novyna', 0),
       (0, 2, 'article_id', '125', 'first-news', 0);
